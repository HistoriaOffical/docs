...
- 5000 Historia: An IPFS masternode requires 5000 HTA. Historia can be obtained from exchanges such as Xeggex. This role gives voting rights to the masternode owner and receives a 50% reward. IPFS daemon is required to provide for content distribution.
...
minimum hardware requirements. As of version v0.17.3.0, these requirements
are as follows:
